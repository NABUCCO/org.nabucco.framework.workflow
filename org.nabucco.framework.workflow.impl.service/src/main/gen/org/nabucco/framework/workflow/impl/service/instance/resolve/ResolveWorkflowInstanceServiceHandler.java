...
/**
 * ResolveWorkflowInstanceServiceHandler<p/>Workflow instance resolution service<p/>
 *
 * @version 1.0
 * @author Nicolas Moser, PRODYNA AG, 2011-03-28
 */
public abstract class ResolveWorkflowInstanceServiceHandler extends PersistenceServiceHandlerSupport implements
        ServiceHandler, PersistenceServiceHandler {

    private static final long serialVersionUID = 1L;

    private static final String ID = "org.nabucco.framework.workflow.impl.service.instance.resolve.ResolveWorkflowInstanceServiceHandler";

    /** Constructs a new ResolveWorkflowInstanceServiceHandler instance. */
    public ResolveWorkflowInstanceServiceHandler() {
        super();
    }
    ...
    protected ServiceResponse<WorkflowInstanceMsg> invoke(ServiceRequest<WorkflowInstanceMsg> rq)
        ...
        try {
            ...
            msg = this.resolveWorkflowInstance(rq.getRequestMessage());
            if ((msg == null)) {
    ...
    /**
     * Resolves a single workflow instance.
     *
     * @param msg the WorkflowInstanceMsg.
     * @return the WorkflowInstanceMsg.
     * @throws ResolveException
     */
    protected abstract WorkflowInstanceMsg resolveWorkflowInstance(WorkflowInstanceMsg msg) throws ResolveException;
