...
/**
 * ResumeWorkflowServiceHandler<p/>Workflow Engine service that executes the workflow transitions<p/>
 *
 * @version 1.0
 * @author Nicolas Moser, PRODYNA AG, 2010-05-04
 */
public abstract class ResumeWorkflowServiceHandler extends PersistenceServiceHandlerSupport implements ServiceHandler,
        PersistenceServiceHandler {

    private static final long serialVersionUID = 1L;

    private static final String ID = "org.nabucco.framework.workflow.impl.service.engine.ResumeWorkflowServiceHandler";

    /** Constructs a new ResumeWorkflowServiceHandler instance. */
    public ResumeWorkflowServiceHandler() {
        super();
    }
     ...
     */
    protected ServiceResponse<WorkflowResultRs> invoke(ServiceRequest<ResumeWorkflowRq> rq) throws WorkflowException {
        ServiceResponse<WorkflowResultRs> rs;
        WorkflowResultRs msg;
        try {
            this.validateRequest(rq);
            this.setContext(rq.getContext());
            msg = this.resumeWorkflow(rq.getRequestMessage());
            if ((msg == null)) {
     ...
     *
     * @param msg the ResumeWorkflowRq.
     * @return the WorkflowResultRs.
     * @throws WorkflowException
     */
    protected abstract WorkflowResultRs resumeWorkflow(ResumeWorkflowRq msg) throws WorkflowException;
