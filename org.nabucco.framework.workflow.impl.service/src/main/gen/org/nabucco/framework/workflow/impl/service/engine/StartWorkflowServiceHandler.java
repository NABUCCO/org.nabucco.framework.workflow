...
/**
 * StartWorkflowServiceHandler<p/>Workflow Engine service that executes the workflow transitions<p/>
 *
 * @version 1.0
 * @author Nicolas Moser, PRODYNA AG, 2010-05-04
 */
public abstract class StartWorkflowServiceHandler extends PersistenceServiceHandlerSupport implements ServiceHandler,
        PersistenceServiceHandler {

    private static final long serialVersionUID = 1L;

    private static final String ID = "org.nabucco.framework.workflow.impl.service.engine.StartWorkflowServiceHandler";

    /** Constructs a new StartWorkflowServiceHandler instance. */
    public StartWorkflowServiceHandler() {
        super();
    }
    ...
    protected ServiceResponse<WorkflowResultRs> invoke(ServiceRequest<InitWorkflowRq> rq) throws WorkflowException {
        ...
        try {
            ...
            msg = this.startWorkflow(rq.getRequestMessage());
            if ((msg == null)) {
     ...
     * @throws WorkflowException
     */
    protected abstract WorkflowResultRs startWorkflow(InitWorkflowRq msg) throws WorkflowException;
