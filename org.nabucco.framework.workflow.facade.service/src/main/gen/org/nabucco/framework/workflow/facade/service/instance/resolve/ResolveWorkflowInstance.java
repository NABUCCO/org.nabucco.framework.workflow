...
/**
 * ResolveWorkflowInstance<p/>Workflow instance resolution service<p/>
 *
 * @version 1.0
 * @author Nicolas Moser, PRODYNA AG, 2011-03-28
 */
public interface ResolveWorkflowInstance extends Service {
     ...
     */
    ServiceResponse<WorkflowInstanceMsg> resolveWorkflowInstance(ServiceRequest<WorkflowInstanceMsg> rq)
            throws ResolveException;
}
