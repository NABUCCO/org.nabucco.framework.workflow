...
/**
 * SearchWorkflowDatatype<p/>Search service for workflow Datatypes<p/>
 *
 * @version 1.0
 * @author Leonid Agranovskiy, PRODYNA AG, 2012-03-16
 */
public interface SearchWorkflowDatatype extends Service {
     ...
     */
    ServiceResponse<TaskListMsg> searchTasks(ServiceRequest<TaskSearchRq> rq) throws SearchException;
}
