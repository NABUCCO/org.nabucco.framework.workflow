 ...
 */
package org.nabucco.framework.workflow.ui.rcp.communication.instance.resolve;
...
public class ResolveWorkflowInstanceDelegate extends ServiceDelegateSupport {
     ...
     */
    public WorkflowInstanceMsg resolveWorkflowInstance(WorkflowInstanceMsg message, ServiceSubContext... subContexts)
            throws ClientException {
        ...
        throw new ClientException("Cannot execute service operation: ResolveWorkflowInstance.resolveWorkflowInstance");
    }
}
