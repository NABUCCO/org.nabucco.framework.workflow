...
/**
 * WorkflowSignalEditView<p/>Edit view for datatype WorkflowSignal<p/>
 *
 * @version 1.0
 * @author Nicolas Moser, PRODYNA AG, 2011-02-18
 */
public class WorkflowSignalEditView extends EditView<WorkflowSignalEditViewModel> {

    public static final String ID = "org.nabucco.framework.workflow.ui.edit.signal.WorkflowSignalEditView";
    ...
    /** Constructs a new WorkflowSignalEditView instance. */
    public WorkflowSignalEditView() {
        super();
    }
    ...
    protected void createFormControl(Form form) {
        ...
        model = new WorkflowSignalEditViewModel();
    ...
    @Override
    public String getId() {
        return WorkflowSignalEditView.ID;
    }
}
