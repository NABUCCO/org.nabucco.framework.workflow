...
/**
 * WorkflowSignalListView<p/>ListView for WorkflowSignals<p/>
 *
 * @author Nicolas Moser, PRODYNA AG, 2011-02-18
 */
public class WorkflowSignalListView extends NabuccoComponentListView<WorkflowSignalListViewModel> {

    public static final String ID = "org.nabucco.framework.workflow.ui.list.signal.WorkflowSignalListView";

    public static final String TAB_TITLE = (ID + ".tabTitle");

    public static final String TITLE = (ID + ".title");

    /** Constructs a new WorkflowSignalListView instance. */
    public WorkflowSignalListView() {
        super();
        model = new WorkflowSignalListViewModel();
    }
    ...
    @Override
    public String getId() {
        return WorkflowSignalListView.ID;
    }
}
