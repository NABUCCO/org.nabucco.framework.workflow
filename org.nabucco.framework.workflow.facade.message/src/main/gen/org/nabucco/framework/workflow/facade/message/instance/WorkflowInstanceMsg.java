...
/**
 * WorkflowInstanceMsg<p/>Message containing a single WorkflowInstance<p/>
 *
 * @author Jens Wurm, PRODYNA AG, 2010-05-04
 */
public class WorkflowInstanceMsg extends ServiceMessageSupport implements ServiceMessage {
    ...
    /** Constructs a new WorkflowInstanceMsg instance. */
    public WorkflowInstanceMsg() {
        super();
        this.initDefaults();
    }
    ...
    public Set<NabuccoProperty> getProperties() {
        ...
        properties.add(super.createProperty(WorkflowInstanceMsg.getPropertyDescriptor(WORKFLOWINSTANCE),
    ...
    public boolean equals(Object obj) {
        ...
        final WorkflowInstanceMsg other = ((WorkflowInstanceMsg) obj);
    ...
    /**
     * Missing description at method getWorkflowInstance.
     *
    ...
    /**
     * Missing description at method setWorkflowInstance.
     *
    ...
    public static NabuccoPropertyDescriptor getPropertyDescriptor(String propertyName) {
        return PropertyCache.getInstance().retrieve(WorkflowInstanceMsg.class).getProperty(propertyName);
    }
    ...
    public static List<NabuccoPropertyDescriptor> getPropertyDescriptorList() {
        return PropertyCache.getInstance().retrieve(WorkflowInstanceMsg.class).getAllProperties();
    }
}
