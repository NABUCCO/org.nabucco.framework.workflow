...
/**
 * WorkflowResultRs<p/>Response Message from Workflow processing holding the Workflow Result.<p/>
 *
 * @version 1.0
...
public class WorkflowResultRs extends ServiceMessageSupport implements ServiceMessage {
    ...
    protected static NabuccoPropertyContainer createPropertyContainer() {
        ...
        propertyMap.put(RESULT, PropertyDescriptorSupport.createDatatype(RESULT, WorkflowResult.class, 0,
    ...
    public Set<NabuccoProperty> getProperties() {
        ...
        properties.add(super.createProperty(WorkflowResultRs.getPropertyDescriptor(RESULT), this.getResult()));
        return properties;
    }
    ...
    public boolean setProperty(NabuccoProperty property) {
        ...
        if ((property.getName().equals(RESULT) && (property.getType() == WorkflowResult.class))) {
            this.setResult(((WorkflowResult) property.getInstance()));
            return true;
        }
        return false;
    }
     ...
     * The Workflow Result.
     *
     * @param result the WorkflowResult.
     */
